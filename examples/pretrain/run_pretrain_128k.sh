#!/bin/bash
# Qwen3-1.6B Summary Attention — 128k pretrain continuing from 64k DCP checkpoint.
#
...
# Paths — ADJUST THESE
# ============================================
CHECKPOINT_DIR=/path/to/muse_outputs/1b6_sa_hybrid_64k   # 64k DCP on first launch; this 128k output on resume
...
OUTPUT_DIR=/path/to/muse_outputs/1b6_sa_hybrid_128k
...
comment="pretrain_1b6_sa_hybrid_128k"
